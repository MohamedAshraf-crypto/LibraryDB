...
-- المشكله هنا ان التابل دا child table يعنى معتمد ع تابل تانى الى هو issue_status ف لازم الكتاب يكون ليه issue date عشان يكون ليه return id فكان موجود ids ملهاش issue date وليها return date ودا الى كان عامل المشكله ف احنا مسحنا الidsدى عشان نحل المشكله
